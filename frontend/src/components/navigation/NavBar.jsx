...
import { LogOut, User as UserIcon, Menu, X, Sun, Moon, Search, Coins, MessageCircle, LayoutDashboard, Compass, Briefcase, ArrowRightLeft, Infinity as InfinityIcon, Package } from 'lucide-react';
                    ...
                    {!user ? (
                        ...
                        <>
                            <Link to="/profile" id="tour-profile" onClick={() => setIsOpen(false)} className="flex flex-col items-center gap-1.5 group transition-all">
                                <span className="text-[11px] font-black text-foreground mb-1">{user.full_name}</span>
