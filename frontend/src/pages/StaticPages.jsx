...
const content = {
  en: {
    about: { 
        title: "About Ahlafot", 
        text: "Ahlafot is redefining the way we exchange value. We've built more than just a marketplace; we've created a dynamic ecosystem where items and professional services find new life through seamless trading. \n\nOur mission is to empower individuals and businesses to leverage their unused assets and specialized skills, fostering a sustainable circular economy. By blending cutting-edge technology with the age-old practice of bartering, Ahlafot makes high-value exchanges accessible, secure, and intuitive for everyone, everywhere." 
    },
    careers: { 
    ...
    terms: { 
        ...
        text: "Your trust is our priority. By engaging with the Ahlafot platform, you join a community built on mutual respect and fair exchange. Our terms are designed to ensure a safe, transparent, and legal environment for all users.\n\nWe facilitate connections, but the integrity of each trade rests with our community. We require all users to be of legal age and strictly prohibit the exchange of regulated or illegal goods. For a detailed breakdown of our user agreements and dispute resolution processes, please review the full document below." 
    },
    privacy: { 
        title: "Privacy & Data Security", 
        text: "At Ahlafot, your data belongs to you. We employ industry-leading encryption and security protocols to ensure that your personal information and trade history remain confidential.\n\nWe collect minimal data—only what is necessary to facilitate secure transactions and improve your experience. We never sell your data to third parties. Our commitment to privacy is absolute, allowing you to trade with peace of mind." 
    },
    company: { 
        title: "The Company", 
        text: "Ahlafot Inc. is a technology leader dedicated to democratizing commerce. Founded in 2024 with a vision of a waste-free world, we operate at the intersection of fintech and sustainability. \n\nOur platform supports thousands of users across the globe, helping them turn idle resources into meaningful value. We are committed to long-term growth, ethical business practices, and building a more connected world." 
    }
  },
  he: {
    about: { 
        title: "אודות Ahlafot", 
        text: "החלפות (Ahlafot) מגדירה מחדש את הדרך שבה אנו מחליפים ערך. בנינו הרבה יותר מסתם זירת מסחר; יצרנו אקו-סיסטם דינמי שבו פריטים ושירותים מקצועיים מוצאים חיים חדשים דרך מסחר חכם ונטול מאמץ.\n\nהמשימה שלנו היא להעניק לאנשים ועסקים את הכלים למנף את הנכסים והכישורים שלהם, תוך קידום כלכלה מעגלית ובת-קיימא. על ידי שילוב של טכנולוגיה מתקדמת עם הפרקטיקה העתיקה של סחר חליפין, Ahlafot הופכת עסקאות בעלות ערך גבוה לנגישות, מאובטחות ואינטואיטיביות עבור כולם, בכל מקום." 
    },
    careers: { 
